...
class __TwigTemplate_9b4cfda0fb99a1bc98d7a448ce10156e7339b1ceb72226396fa6ec94ac34a902 extends Template
{
    private $source;
    private $macros = [];
            ...
            if (twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "listeners", [], "any", true, true, false, 227)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "listeners", [], "any", false, false, false, 227), [])) : ([])))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                    ...
                    echo "</td>
                                    <td class=\"no-wrap\">";
                    // line 253
                    echo twig_escape_filter($this->env, sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, $context["listener"], "time", [], "any", false, false, false, 253) * 1000)), "html", null, true);
                    echo " ms</td>
                                    <td class=\"font-normal\">";
                    // line 254
            ...
            if ( !twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "authenticators", [], "any", true, true, false, 269)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "authenticators", [], "any", false, false, false, 269), [])) : ([])))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["authenticator"]) {
                    ...
                    echo "</td>
                                    <td class=\"no-wrap\">";
                    // line 294
                    echo twig_escape_filter($this->env, sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, $context["authenticator"], "duration", [], "any", false, false, false, 294) * 1000)), "html", null, true);
                    echo " ms</td>
                                    <td class=\"font-normal\">";
                    // line 295
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/home/snowballe/PhpstormProjects/mael_loussouarn_eval/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
