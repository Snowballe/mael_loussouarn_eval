...
class __TwigTemplate_13f41d3e4fbae68afbccebe4c4a837c13d6f02fd7b3e0d473a9b010016b1c1d5 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["connection"]) || array_key_exists("connection", $context) ? $context["connection"] : (function () { throw new RuntimeError('Variable "connection" does not exist.', 7, $this->source); })()), 'form');
        echo "
";
...
{% block body %}
    <h2>Connexion</h2>
    {{ form(connection) }}
{% endblock %}", "home/login.html.twig", "/home/snowballe/PhpstormProjects/mael_loussouarn_eval/templates/home/login.html.twig");
    }
}
